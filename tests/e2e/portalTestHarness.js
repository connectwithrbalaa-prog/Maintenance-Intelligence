...
function createPortalHarness(options = {}) {
  ...
  const defaultRunDetailsById = {
    'RUN-123': {
      ...
      evidence_ids: ['EV-9', 'DOC-1', 'SIG-901'],
      ...
      model: { name: 'gpt-4.1', version: 'test', latency_ms: 812, confidence: 0.83 },
      context_meta: { asset_id: 'PUMP-101', event_kind: 'anomaly', doc_chunk_ids: ['DOC-1'], signal_ids: ['SIG-901'] },
      updated_at: '2026-03-15T10:00:00Z',
      source_file: 'RUN-123.json',
    },
    'RUN-099': {
      ...
      root_causes: ['Seal alignment drift'],
      contributing_factors: ['Recent coupling wear'],
      evidence_ids: ['EV-4', 'DOC-4', 'SIG-777'],
      ...
      model: { name: 'gpt-4.1', version: 'test', latency_ms: 764, confidence: 0.71 },
      context_meta: { asset_id: 'PUMP-101', event_kind: 'inspection', doc_chunk_ids: ['DOC-4'], signal_ids: ['SIG-777'] },
      updated_at: '2026-03-14T08:00:00Z',
      source_file: 'RUN-099.json',
    },
  };
