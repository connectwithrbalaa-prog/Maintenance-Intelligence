...
function createPortalHarness(options = {}) {
  ...
  const defaultRunDetailsById = {
    'RUN-123': {
      ...
      root_causes: ['Bearing degradation from lubrication loss', 'Lubrication instability'],
      contributing_factors: ['High ambient temperature', 'Recent overload trip'],
      evidence_ids: ['EV-9', 'DOC-1', 'DOC-COMMON', 'SIG-901'],
      ...
      model: { name: 'gpt-4.1', version: 'test', latency_ms: 812, confidence: 0.83 },
      context_meta: { asset_id: 'PUMP-101', event_kind: 'anomaly', doc_chunk_ids: ['DOC-1', 'DOC-COMMON'], signal_ids: ['SIG-901'] },
      updated_at: '2026-03-15T10:00:00Z',
      source_file: 'RUN-123.json',
    },
    'RUN-099': {
      ...
      event_id: 'EV-4',
      recommendation_id: 'REC-21',
      repair_plan_id: 'RP-099',
      title: 'Inspect seal and rebalance coupling',
      summary: 'Previous run pointed to seal alignment and coupling drift.',
      confidence: 0.71,
      hypothesis: ['Seal misalignment is raising load'],
      root_causes: ['Seal alignment drift', 'Lubrication instability'],
      contributing_factors: ['Recent coupling wear', 'High ambient temperature'],
      evidence_ids: ['EV-4', 'DOC-4', 'DOC-COMMON', 'SIG-777'],
      ...
      structured: {
        ...
        repair_plan: {
          plan_id: 'RP-099',
          procedure_steps: [
            { seq: 1, action: 'Inspect seal housing', safety_note: 'Verify guards are removed', estimated_mins: 20 },
            { seq: 2, action: 'Capture vibration spectrum', safety_note: 'Keep clear of rotating equipment', estimated_mins: 35 },
          ],
          tools_required: ['Vibration analyzer'],
          safety_requirements: ['LOTO required'],
          permit_type: 'standard',
          estimated_duration_hrs: 2.5,
          spare_parts_cost_estimate: 420,
          parts_list: [
            {
              part_no: 'SEAL-42',
      ...
      repair_plan: {
        ...
        org_id: 'ops-demo',
        asset_id: 'PUMP-101',
        summary: 'Inspect the seal train and rebalance the coupling before returning to service.',
        rationale: 'Seal drift and coupling wear were the leading signals in the prior run.',
        confidence: 0.71,
        status: 'draft',
        created_at: '2026-03-14T08:03:00Z',
        updated_at: '2026-03-14T08:04:00Z',
        procedure_steps: [
          { seq: 1, action: 'Inspect seal housing', safety_note: 'Verify guards are removed', estimated_mins: 20 },
          { seq: 2, action: 'Capture vibration spectrum', safety_note: 'Keep clear of rotating equipment', estimated_mins: 35 },
        ],
      ...
      model: { name: 'gpt-4.1', version: 'test', latency_ms: 764, confidence: 0.71 },
      context_meta: { asset_id: 'PUMP-101', event_kind: 'inspection', doc_chunk_ids: ['DOC-4', 'DOC-COMMON'], signal_ids: ['SIG-777'] },
      updated_at: '2026-03-14T08:00:00Z',
      source_file: 'RUN-099.json',
    },
  };
