...
def test_process_event_uses_deterministic_local_fallback_when_edge_mode_has_no_gateway(
    ...
    monkeypatch.setattr(
        ...
        lambda evt, settings: {
            ...
            "fleet_context_summary": {
                ...
                "referenced_sources": [],
                "current_asset_id": evt.get("asset_id"),
            },
        },
    )
    monkeypatch.setattr(
...
def test_process_event_uses_deterministic_local_fallback_when_gateway_reports_genai_error(
    monkeypatch, tmp_path
):
    written = {}
    sent = {}
