...
class Settings(BaseSettings):
    ...
    sap_pm_base_url: str | None = Field(default=None)
    sap_pm_plant: str = Field(default="1000")
    sap_pm_order_type: str = Field(default="PM01")
    sap_pm_username: str | None = Field(default=None)
    sap_pm_password: str | None = Field(default=None)
    sap_pm_timeout_s: int = Field(default=15)
    servicenow_base_url: str | None = Field(default=None)
    servicenow_table: str = Field(default="wm_order")
    servicenow_username: str | None = Field(default=None)
    servicenow_password: str | None = Field(default=None)
    servicenow_timeout_s: int = Field(default=15)
