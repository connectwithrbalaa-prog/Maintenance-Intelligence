...
class Settings(BaseSettings):
    ...
    auth_jwt_jwks_url: str | None = Field(default=None)
    auth_jwt_audience: str | None = Field(default=None)
    auth_jwt_issuer: str | None = Field(default=None)
    auth_jwt_algorithms: str = Field(default="RS256")
    auth_jwt_leeway_s: int = Field(default=30)
    auth_jwt_org_claim: str = Field(default="org_id")
    auth_jwt_roles_claim: str = Field(default="roles")
    auth_jwt_sites_claim: str = Field(default="site_ids")
