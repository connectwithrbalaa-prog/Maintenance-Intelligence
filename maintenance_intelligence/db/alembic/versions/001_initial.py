...
def upgrade() -> None:
    ...
    op.create_table('signal_rollups',
    ...
    # Indexes
    op.create_index('idx_signals_asset_type_time', 'signals', ['asset_id', 'signal_type', 'timestamp'])
    op.create_index('idx_rollups_asset_type_period', 'signal_rollups', ['asset_id', 'signal_type', 'period', 'start_time'])
